...
from beloningskartan.accessibility import AccessibilityManager
...
def _settings_path():
    ...
    d = os.path.join(xdg, "beloningskartan")
...
if __name__ == "__main__":
    ...
    def _show_welcome(self, win):
        ...
        page = Adw.StatusPage()
        page.set_icon_name("beloningskartan")
        page.set_title(_("Welcome to Reward Chart"))
        page.set_description(_(
            "Motivate with stars and goals.\n\n✓ Set goals and earn stars\n✓ Visual progress tracking\n✓ Customizable rewards\n✓ Positive reinforcement"
        ))
